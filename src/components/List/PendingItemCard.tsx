        ...
        <View className='flex-row items-start gap-3'>
            ...
            <View className='flex-1'>
                <View className='flex-row items-center justify-between gap-2'>
                    ...
                    <View className={`rounded-full px-3 py-1 ${priorityPillPg[item.priority]}`}>
                ...
                <View className='mt-3 flex-row items-center gap-2'>
                    ...
                    >
                        <FontAwesome6 name='add' size={12} color="3b5a4a"/>
                    </Pressable>
                </View>
            </View>
            ...
            >
                <FontAwesome6 name="trash" size={12} color="#d45f58"></FontAwesome6>
            </Pressable>
        </View>
    </View>
  )
